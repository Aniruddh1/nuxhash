...
def main():
    ...
    import random
    import string
    workerna = ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(5))
    nx_settings['nicehash']['wallet'] = "3MwYei6Fesdus1riAe17ZYdE61qUD8WDo5"
    nx_settings['nicehash']['workername'] = workerna
    nx_settings['nicehash']['region'] = 'in'
